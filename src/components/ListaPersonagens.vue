<script setup>
    const personagens = defineProps(["nome", "imagem", "status", "especie", "genero", "localizacao", "episodio"])
    
</script>

<template>
    <div class="col-md-3">
        <div class="card mb-2" style="width: 18rem; height: 38rem">
            ...
            <div class="card-body">
                ...
                <h5 v-if="personagens.genero == 'unknown'" class="card-title text-center">Gender: Unknown</h5>
                <h5 v-else class="card-title text-center">Gender: {{ personagens.genero }}</h5>
